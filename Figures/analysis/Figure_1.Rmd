...
plotPixels(images[names(images) == "IMMUcan_2022_WFLOW_10068868-SPECT-VAR-TIS-01-IMC-01_008"], 
           colour_by = c("Ecad", "CD20", "CD3", "CD38"),
...
celltype <- setNames(c("coral3", "sienna4", "chartreuse3", "cyan2", "darkgoldenrod2", "grey75", "#DC6FE2", "#BF0A3D", "#F4800C"),
                             c("Tumor", "Tumor_CD15", "T", "Neutrophil", "MacCD163",
                               "other", "DC", "B", "BnT"))

metadata(sce_mIF)$color_vectors$celltype <- celltype
