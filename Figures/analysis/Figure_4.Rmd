...
ggsave(filename = "output/Figure_4/Figure_4B_1.pdf", plot = p_final, width = 30, height = 15)
```
...
ggsave(filename = "output/Figure_4/Figure_4B_2.pdf", plot = p, width = 10, height = 7)
```
