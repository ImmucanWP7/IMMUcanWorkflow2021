...
p
ggsave (filename = "Fig_4A.png", plot = p, device = "png", path = "../output/Figure_4/", width=200, height=150, units='mm', dpi=600)
...
label_sce <- aggregateAcrossCells(cyto_sce,cyto_sce$label, statistics= "mean", use.assay.type="scaled")
...
pdf(file = "../output/Figure_4/Fig_4B.pdf", width = 12, height = 6)
...
ggsave (filename = "Fig_4C.pdf", plot = p, device = "pdf", path = "../output/Figure_4/", width = 22, height = 12, units='cm')
...
p <- ggplot(marker_cv_act, aes(x = variable))+
  ...
  ylab("mean CV")
p
ggsave (filename = "Fig_4D_activated.pdf", plot = p, device = "pdf", path = "../output/Figure_4/", width = 12, height = 4.6, units = "cm")
```
...
p <- ggplot(marker_cv_non_act, aes(x = variable))+
  ...
  ylab("mean CV")
p
ggsave (filename = "Fig_4D_non_activated.pdf", plot = p, device = "pdf", path = "../output/Figure_4/", width = 12, height = 8, units = "cm")
```
