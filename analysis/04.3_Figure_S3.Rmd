...
p <- dittoDimPlot(cyto_sce, var = "Activation_status", 
                  ...
                  do.label = FALSE)
p
ggsave (filename = "Fig_S3A.png", plot = p, device = "png", path = output, width=200, height=150, units='mm', dpi=600)
...
p <- dittoDimPlot(cyto_sce, var = "Panel", 
                  ...
                  do.label = FALSE)
p
ggsave (filename = "Fig_S3B.png", plot = p, device = "png", path = output, width=200, height=150, units='mm', dpi=600)
```
...
png(file = "output/Figure_S3/Figure_S3_UMAPmarkers.png",width = 2000 ,height = 1200)
...
pdf(file = "output/Figure_S3/Fig_S3D.pdf",width = 8, height = 4)
...
p
ggsave (filename = "Fig_S3E.pdf", plot = p, device = "pdf", path = output, width = 16, height = 10, units = "cm")
```
...
p <- ggplot(marker_cv_non_act, aes(x = variable))+
  ...
  ylab("mean CV")
p
ggsave (filename = "Fig_S3G_non_activated.pdf", plot = p, device = "pdf", path = output, width = 12, height = 8, units = "cm")
```
...
ggsave (filename = "Fig_S3E.png", plot = p, device = "png", path = output, width=350, height=300, units='mm', dpi=600)
