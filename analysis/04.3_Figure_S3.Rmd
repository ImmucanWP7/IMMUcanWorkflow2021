...
```{r}
mean_sce <- aggregateAcrossCells(sce_imc,
                                 ids = DataFrame(sample = sce_imc$sample_id,
                                                  celltype = sce_imc$celltype),
                                 statistics = "mean")
```   
...
# p
# 
# ggsave("output/Figure_S3/Figure_S3_A.pdf", p, width = 12, height = 8)
# 
# p <- colData(sce_imc) %>%
#   as_tibble() %>%
...
# p
# 
# ggsave("output/Figure_S3/Figure_S3_B.pdf", p, width = 12, height = 8)
```
