...
```{r}
if (!dir.exists("output/Figure_S9/")) dir.create("output/Figure_S9/")
...
ggsave(filename = "Fig_S9A_IMC.png",path=output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
...
ggsave(filename = "Fig_S9A_mIF.png",path=output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
```
...
p
ggsave(filename = "Fig_S9B.pdf",path=output, plot = p, width = 8, height = 6)
```
# spatial comparison
...
ggsave(filename = "Fig_S9C.pdf",path=output, plot = p, width = 6, height = 4)
```
