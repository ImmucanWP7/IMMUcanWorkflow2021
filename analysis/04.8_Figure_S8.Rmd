...
#ggsave(filename = "output/Figure_S8/FigS6_1.pdf", plot = p, width = 20, height = 49)
ggsave(filename = "FigS8_1.png",path= output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
...
#ggsave(filename = "output/Figure_S8/FigS6_2.pdf", plot = p, width = 20, height = 49)
ggsave(filename = "FigS8_2.png",path= output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
```
