...
ggsave(filename = "Fig_S8A_IMC.png",path=output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
...
ggsave(filename = "Fig_S8A_mIF.png",path=output, plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
```
...
p
ggsave(filename = "Fig_S8B.pdf",path=output, plot = p, width = 8, height = 6)
```
# spatial comparison
...
ggsave(filename = "Fig_S8C.pdf",path=output, plot = p, width = 6, height = 4)
```
