...
saveRDS(sce, "O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/Rout/sce_whole_slide.rds")
```
...
```{r}
saveRDS(sce, "O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/Rout/sce_ROIs.rds")
```
...
cur_path <- "O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/multichannel_images/img/"
...
for (i in seq_along(cur_folders)) {
    ...
    writeImage(as.array(cur_channels)/(2^16 - 1),
               paste0("O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/multichannel_images/img/",
                      basename(cur_folders[i]), ".tiff"),
               bits.per.sample = 16)
}

images <- loadImages("O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/multichannel_images/img/", 
                     as.is = TRUE)
...
saveRDS(images, "O:/projects/immucan/processed_data/Panel_1/2022_WORKFLOW/mIF/Rout/images.rds")
```
