...
for (i in seq_along(cur_folders)) {
    ...
    writeImage(as.array(cur_channels)/(2^16 - 1),
               paste0("/Volumes/immucan_volume/processed_data/Panel_1/2022_WORKFLOW/mIF/multichannel_images/img/",
                      basename(cur_folders[i]), ".tiff"),
               bits.per.sample = 16)
}

images <- loadImages("/Volumes/immucan_volume/processed_data/Panel_1/2022_WORKFLOW/mIF/multichannel_images/img/", 
                     as.is = TRUE)
