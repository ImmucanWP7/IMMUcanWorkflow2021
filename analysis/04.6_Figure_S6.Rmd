...
ggsave(filename = "output/Figure_S6/FigS6_1.png", plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
...
ggsave(filename = "output/Figure_S6/FigS6_2.png", plot = p, device = "png",width = 210, height = 297, units = "mm", dpi = "print")
```
