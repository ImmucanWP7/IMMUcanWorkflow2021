...
ggsave(filename = "output/Figure_S4/FigS4_A.pdf", plot = p)
```
...
p <- ggplot(out) + 
  ...
  geom_point(aes(modality, prop, color = sample_id)) +
...
ggsave(filename = "output/Figure_S4/FigS4_B.pdf", plot = p, height = 5, width = 15)
```
...
ggsave(filename = "output/Figure_S4/FigS4_A_1.pdf", plot = p, width = 20, height = 49)
...
ggsave(filename = "output/Figure_S4/FigS4_A_2.pdf", plot = p, width = 20, height = 49)

p <- plotSpatial(all_sce[,all_sce$modality == "IMC"], 
            node_color_by = "tissue.type", 
            ncols = 4, img_id = "sample_id") 

ggsave(filename = "output/Figure_S4/FigS4_A_3.pdf", plot = p, width = 20, height = 49)

p <- plotSpatial(all_sce[,all_sce$modality == "mIF"], 
            node_color_by = "tissue.type", 
            ncols = 4, img_id = "sample_id") 

ggsave(filename = "output/Figure_S4/FigS4_A_4.pdf", plot = p, width = 20, height = 49)
...
ggsave(filename = "output/Figure_S4/FigS4_A_5.pdf", plot = p, width = 20, height = 49)

p <- plotSpatial(all_sce[,all_sce$modality == "mIF"], 
            node_color_by = "CD20_logical", 
            ncols = 4, img_id = "sample_id") 

ggsave(filename = "output/Figure_S4/FigS4_A_6.pdf", plot = p, width = 20, height = 49)
```
