...
The code reads data from labelled images to build a random forest classifier which was used to predict the cell types.
The classifier is also the general classifier used for Panel 1 IMC data in the immucan consortium.
...
saveRDS(rffit, file = "O:/projects/immucan/processed_data/Panel_1/classification/raw/data/rf_images_DCfix.rds")
```
