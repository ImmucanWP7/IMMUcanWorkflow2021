---
title: "Alignment from IF to slidescanner"
author: "Nils Eling"
date: "2021-10-18"
...
First, we will test the offset when aligning the IF and slidescanner images.
...
library(ggplot2)
points_1 <- list.files("/Volumes/immucan_volume/raw_data/Panel_1/Batch20210304_workflow_paper/IF_regions_validations/validation_points_Slidescanner/",
                       full.names = TRUE)
points_2 <- list.files("/Volumes/immucan_volume/raw_data/Panel_1/Batch20210304_workflow_paper/IF_regions_validations/transformed_points_jpg_to_czi/",
                       full.names = TRUE)

points_1 <- lapply(points_1, read.csv)
names(points_1) <- list.files("/Volumes/immucan_volume/raw_data/Panel_1/Batch20210304_workflow_paper/IF_regions_validations/validation_points_Slidescanner/",
                       full.names = FALSE)

points_2 <- lapply(points_2, read.csv)
names(points_2) <- list.files("/Volumes/immucan_volume/raw_data/Panel_1/Batch20210304_workflow_paper/IF_regions_validations/transformed_points_jpg_to_czi/",
                       full.names = FALSE)
```
