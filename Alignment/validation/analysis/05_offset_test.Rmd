...
ggplot(cur_df) + geom_point(aes(sample, euclidean, color = slide)) + theme_minimal(base_size = 15) + 
  theme(axis.text.x = element_blank())

ggplot(cur_df) + geom_point(aes(sample, euclidean, color = position)) + theme_minimal(base_size = 15) +
  theme(axis.text.x = element_blank())

ggplot(cur_df) + geom_point(aes(sample, euclidean, color = as.character(point))) + theme_minimal(base_size = 15) +
  theme(axis.text.x = element_blank())

ggplot(cur_df) + geom_point(aes(sample, euclidean, color = rep)) + theme_minimal(base_size = 15) +
  theme(axis.text.x = element_blank())
```
